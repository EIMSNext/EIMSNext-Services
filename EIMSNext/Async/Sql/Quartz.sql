...
BEGIN
    ...
    DROP INDEX IF EXISTS [IDX_QRTZ_SKIP_TRIGGERS_INST_JOB_REQ_RCVRY] ON [dbo].[QRTZ_SKIP_TRIGGERS];
    DROP INDEX IF EXISTS [IDX_QRTZ_SKIP_TRIGGERS_G_J] ON [dbo].[QRTZ_SKIP_TRIGGERS];
    DROP INDEX IF EXISTS [IDX_QRTZ_SKIP_TRIGGERS_G_T] ON [dbo].[QRTZ_SKIP_TRIGGERS];
    ...
    IF OBJECT_ID(N'[dbo].[QRTZ_SKIP_TRIGGERS]', N'U') IS NOT NULL
    DROP TABLE [dbo].[QRTZ_SKIP_TRIGGERS];
...
CREATE TABLE [dbo].[QRTZ_FIRED_TRIGGERS] (
  ...
  [FIRED_PROP_1] nvarchar(512) NULL,
  [FIRED_PROP_2] nvarchar(512) NULL,
  [FIRED_PROP_3] nvarchar(512) NULL,
  [FIRED_PROP_4] nvarchar(512) NULL,
  [FIRED_PROP_5] nvarchar(512) NULL
);
...
CREATE TABLE [dbo].[QRTZ_SKIP_TRIGGERS] (
  [SCHED_NAME] nvarchar(120) NOT NULL,
  [ENTRY_ID] nvarchar(140) NOT NULL,
  [TRIGGER_NAME] nvarchar(150) NOT NULL,
  [TRIGGER_GROUP] nvarchar(150) NOT NULL,
...
ALTER TABLE [dbo].[QRTZ_SKIP_TRIGGERS] WITH NOCHECK ADD
  CONSTRAINT [PK_QRTZ_SKIP_TRIGGERS] PRIMARY KEY  CLUSTERED
  (
    [SCHED_NAME],
    [ENTRY_ID]
  );
...
CREATE INDEX [IDX_QRTZ_SKIP_TRIGGERS_INST_JOB_REQ_RCVRY] ON [dbo].[QRTZ_SKIP_TRIGGERS](SCHED_NAME, INSTANCE_NAME, REQUESTS_RECOVERY);
CREATE INDEX [IDX_QRTZ_SKIP_TRIGGERS_G_J]                ON [dbo].[QRTZ_SKIP_TRIGGERS](SCHED_NAME, JOB_GROUP, JOB_NAME);
CREATE INDEX [IDX_QRTZ_SKIP_TRIGGERS_G_T]                ON [dbo].[QRTZ_SKIP_TRIGGERS](SCHED_NAME, TRIGGER_GROUP, TRIGGER_NAME);
GO