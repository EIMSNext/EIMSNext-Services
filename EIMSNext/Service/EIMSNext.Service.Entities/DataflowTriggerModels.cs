...
namespace EIMSNext.Service.Entities
{
    ...
    /// 数据流触发类型。
    /// </summary>
    public enum DataflowTriggerKind
    {
        /// <summary>
        /// 表单触发。
        /// </summary>
    ...
    /// 定时触发时间源类型。
    /// </summary>
    public enum DataflowScheduleSourceType
    {
        /// <summary>
        /// 自定义时间。
        /// </summary>
    ...
    /// 数据流定时触发设置。
    /// </summary>
    public class DataflowTimeTriggerSetting
    {
        /// <summary>
        /// 时间源类型。
        /// </summary>
    ...
    /// 数据流HTTP样例字段。
    /// </summary>
    public class DataflowHttpSampleField
    {
        /// <summary>
        /// 字段键。
        /// </summary>
    ...
    /// 数据流HTTP触发设置。
    /// </summary>
    public class DataflowHttpTriggerSetting
    {
        /// <summary>
        /// 允许触发的IP列表。
        /// </summary>
        ...
        /// HTTP字段样例。
        /// </summary>
        public List<DataflowHttpSampleField>? SampleFields { get; set; }
    }

    /// <summary>
    /// HTTP触发请求上下文。
    /// </summary>
    public class DataflowHttpRequestContext
    {
        /// <summary>
        /// 客户端IP。
        /// </summary>
        ...
        /// 扁平化字段列表。
        /// </summary>
        public List<DataflowHttpSampleField> Fields { get; set; } = [];
