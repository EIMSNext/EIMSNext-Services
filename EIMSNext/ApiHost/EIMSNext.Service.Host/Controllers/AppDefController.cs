...
namespace EIMSNext.Service.Host.Controllers
{
    ...
    public class AppDefController(IResolver resolver) : ApiControllerBase<AppDefApiService, AppDef, AppDefViewModel>(resolver)
    {
        ...
        public ActionResult<AppDef> CreateGroup([FromBody] CreateAppGroupRequest request)
        {
        ...
        [HttpPost("EditGroup")]
        public ActionResult<AppDef> EditGroup([FromBody] EditAppGroupRequest request)
        {
        ...
        [HttpPost("EditMenu")]
        public ActionResult<AppDef> EditMenu([FromBody] EditAppMenuRequest request)
        {
            if (string.IsNullOrWhiteSpace(request.AppId) || string.IsNullOrWhiteSpace(request.MenuId) || string.IsNullOrWhiteSpace(request.Name))
            {
        ...
        public ActionResult<AppDef> DeleteGroup([FromBody] DeleteAppGroupRequest request)
        {
        ...
        [HttpPost("SaveMenus")]
        public ActionResult<AppDef> SaveMenus([FromBody] SaveAppMenusRequest request)
        {
