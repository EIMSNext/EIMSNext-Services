...
namespace EIMSNext.Identity.Tests
{
    ...
    public class IntegrationAuthServiceTests
    {
        ...
        {
            var dbContext = new FakeIdentityDbContext(
                settings:
                [
        ...
        private sealed class FakeIdentityDbContext(
            ...
            IEnumerable<UserIntegrationBinding>? bindings = null) : IIdentityDbContext
        {
            ...
            public Task AddIdentityLoginAudits(IReadOnlyCollection<IdentityLoginAudit> entities, CancellationToken cancellationToken = default) => Task.CompletedTask;
