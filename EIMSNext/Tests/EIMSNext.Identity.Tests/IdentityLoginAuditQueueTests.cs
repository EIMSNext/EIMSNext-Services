...
public class IdentityLoginAuditQueueTests
{
    ...
    private sealed class RecordingIdentityDbContext : IIdentityDbContext
    {
        ...
        public IQueryable<IntegrationLoginSetting> IntegrationLoginSettings => Array.Empty<IntegrationLoginSetting>().AsQueryable();
        public IQueryable<UserIntegrationBinding> UserIntegrationBindings => Array.Empty<UserIntegrationBinding>().AsQueryable();
        ...
        public Task AddIntegrationLoginSetting(IntegrationLoginSetting entity) => Task.CompletedTask;
        public Task UpdateIntegrationLoginSetting(IntegrationLoginSetting entity) => Task.CompletedTask;
        public Task AddUserIntegrationBinding(UserIntegrationBinding entity) => Task.CompletedTask;
