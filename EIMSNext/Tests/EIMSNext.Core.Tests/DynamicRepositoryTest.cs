...
namespace EIMSNext.Core.Tests
{
    ...
    public class DynamicRepositoryTest : TestBase
    {
        ...
        public void InsertTest()
        {
            ...
            var result = resp.Find(new DynamicFindOptions<FormData>() { Take = 10 }, _scope?.SessionHandle);
        ...
        {
            var data0 = "{\"id\":\"\",\"appId\":\"68144ea3ee5f2aa4d37c02dd\",\"formId\":\"6877c3129839c3f592a87f98\",\"data\":{\"jxqoyp2pzq6orpoy\":\"1\",\"jiavqvqlmg0u3nmc\":\"1\",\"jkxo31f8215xjjel\":[{\"js0utbcbwu8qby53\":\"1\",\"jsne7rbcebsw3du0\":1},{\"js0utbcbwu8qby53\":\"2\",\"jsne7rbcebsw3du0\":2}]}}".DeserializeFromJson<FormData>();
            ...
            var result = resp.Find(new DynamicFindOptions<FormData> { Filter = new DynamicFilter { Field = "data.f_1721094301870", Op = FilterOp.Eq, Value = "bbb" } }, _scope?.SessionHandle);
            Assert.AreEqual(1, result.CountDocuments());

            result = resp.Find(new DynamicFindOptions<FormData> { Filter = new DynamicFilter { Field = "data.f_1721094301870", Op = FilterOp.In, Value = new List<object> { "bbb", "ccc" } } }, _scope?.SessionHandle);
            ...
            result = resp.Find(new DynamicFindOptions<FormData> { Filter = new DynamicFilter { Field = "createTime", Op = FilterOp.Gt, Value = DateTime.Today.ToTimeStampMs() } }, _scope?.SessionHandle);
            Assert.AreEqual(3, result.CountDocuments());

            result = resp.Find(new DynamicFindOptions<FormData> { Filter = new DynamicFilter { Field = "data.f_1721094301874>f_1721094301876", Op = FilterOp.Eq, Value = "1113" } }, _scope?.SessionHandle);
            Assert.AreEqual(2, result.CountDocuments());

            result = resp.Find(new DynamicFindOptions<FormData> { Filter = new DynamicFilter { Field = "data.f_1721094301874>f_1721094301877", Op = FilterOp.Gt, Value = 4442 } }, _scope?.SessionHandle);
            Assert.AreEqual(1, result.CountDocuments());
        }
        ...
        public void UpdateTest()
        {
            ...
            var list = new List<UpdateDefinition<FormData>>();
        ...
        public void DeleteTest()
        {
            ...
            var result = resp.Find(new DynamicFindOptions<FormData>());
            Assert.AreEqual(1, result.CountDocuments());
